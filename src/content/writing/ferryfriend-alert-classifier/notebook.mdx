...
> This is a notebook I wrote while working on a project to classify WSF ferry alerts using scikit-learn. The output of each cell is rendered below the cell as it is in the notebook. [See the project writeup here](/writing/ferry-alert-classifier).
