...
![Labelling app](/images/alerts/sklearn_13_1.png)

## Build a Classifier Model

After collecting and annotating a few thousand alerts, I decided to dig into building a classifier. Based on a fair amount of reading through the Scikit-learn docs (and a fairer amount of trial and error), I settled on a Support Vector Machine as the likeliest candidate for building an effective model. 

<Sidenote>
The full Jupyter notebook can be seen [here](/alerts/notebook).
</Sidenote>
...
high_priority_termina    0.89      0.92      0.90       228
...
![Confusion Matrix](/images/alerts/sklearn_17_1.png)
